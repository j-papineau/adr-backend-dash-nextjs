      ...
      <CardContent>
        <div className='flex flex-row justify-between'>
            ...
            <Tooltip title={"CtL: 28%, Prof: $200, CpL: $22, Closing: 32.5% "}>
                <Button size={"small"}>About Targets</Button>
            </Tooltip>  
        </div>
        ...
        <div className='flex flex-row space-x-4 items-center'>
            <Typography variant="h5" component="div" className={ctlGood ? "text-green-500" : "text-red-500"}>
        ...
        <div className='flex flex-row space-x-4 items-center'>
            <Typography variant="h5" component="div" className={cplGood ? "text-green-500" : "text-red-500"}>
        ...
        <div className='flex flex-row space-x-4 items-center'>
            <Typography variant="h5" component="div" className={closingGood ? "text-green-500" : "text-red-500"}>
